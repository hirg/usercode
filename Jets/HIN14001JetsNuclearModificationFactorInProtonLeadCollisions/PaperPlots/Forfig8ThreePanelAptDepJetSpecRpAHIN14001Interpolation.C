...
void Forfig8ThreePanelAptDepJetSpecRpAHIN14001Interpolation(Display_t dis = kRpA, Level_t lev = kUnfold, DataSet_t data=kAll)
{
    TH1::SetDefaultSumw2();
    ...
    TString plotsdir = "/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/plots";
        //const char * kHomeDir = "/Users/ymao/group/CMS/anaOutputs/pPb/RpPb" ;
        const char * kHomeDir = "/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12" ;
...
//        {286101, -47.4919, -5.34629, 6.8595, -1.05411}};
    ...
    for(int ieta = 0 ; ieta <=netabin; ieta++){
        if(ieta==netabin){
            if(dis==kSpecPb || dis==kRpA || dis==kRpAEtaDep)
                ...
                inname = Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/sys/sysSpectrumTotalEtaBin%.f_%.f.txt", -1.0*10, 1.0*10);
            else
               //inname =Form("/Users/ymao/group/CMS/Sys/HIN-14-001/sysAsymmetetryTotalEtaBin%.f_%.f.txt",-1.0*10, 1.0*10);
               inname =Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/sys/sysAsymmetetryTotalEtaBin%.f_%.f.txt",-1.0*10, 1.0*10);
        }
        else {
            if(dis==kSpecPb || dis==kRpA || dis==kRpAEtaDep)
                //inname = Form("/Users/ymao/group/CMS/Sys/HIN-14-001/sysSpectrumTotalEtaBin%.f_%.f.txt",deta[ieta]*10, deta[ieta+1]*10);
                inname = Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/sys/sysSpectrumTotalEtaBin%.f_%.f.txt",deta[ieta]*10, deta[ieta+1]*10);
            else
                //inname =Form("/Users/ymao/group/CMS/Sys/HIN-14-001/sysAsymmetetryTotalEtaBin%.f_%.f.txt",deta[ieta]*10, deta[ieta+1]*10);
                inname =Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/sys/sysAsymmetetryTotalEtaBin%.f_%.f.txt",deta[ieta]*10, deta[ieta+1]*10);
        }
    ...
    for(int ieta = 0 ; ieta <=netabin; ieta++){
        if(ieta==netabin){
            ...
            //innamepp = Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/pp/ppReferenceFrom7TeVR5SysEtaBin%.f_%.f.txt", -1.0*10, 1.0*10);
            innamepp = Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/pp/ppRefSysTotalEtaBin%.f_%.f.txt", -1.0*10, 1.0*10);
            //            else
            ...
            //innamepp = Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/pp/ppReferenceFrom7TeVR5SysEtaBin%.f_%.f.txt",deta[ieta]*10, deta[ieta+1]*10);
            innamepp = Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/pp/ppRefSysTotalEtaBin%.f_%.f.txt",deta[ieta]*10, deta[ieta+1]*10);
            //            else
    ...
    fcorr = TFile::Open("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/QCD10011Binning/correctionfactor.root", "readonly");
    ...
    if(UsePYTHIARef){
        ...
        reffile = new TFile(Form("/Users/tuos/Analysis/CMS/eps09/jetpp/dplot9May12/pp/R3_ScaleFactor7TeVto5TeVStartingCone5Sys-2.root"));
...
//    c1->SetFrameBorderMode(0);
    ...
    TCanvas *c1 = new TCanvas("c1", "c1",9,2,1099,469);
    gStyle->SetOptFit(1);
    gStyle->SetOptStat(0);
    gStyle->SetOptTitle(0);
...
//    c1->SetLogy();
    c1->SetTickx(1);
    c1->SetTicky(1);
    c1->SetLeftMargin(0.152174);
    c1->SetRightMargin(0.00434783);
    c1->SetTopMargin(0.1159166969);
    c1->SetBottomMargin(0.1588566);
    c1->SetFrameFillStyle(0);
...
//            hhdum->GetYaxis()->SetTitle("1/N_{ev}d^{2}N/dp_{T}d#eta");
    ...
    if(ieta==2) gPad->SetRightMargin(0.02);
            gStyle->SetErrorX(0.5);
    if(ieta==0){
        hDum0=(TH1F*)hDum->Clone();
        hDum0->GetXaxis()->SetTitleSize(0.07);
        hDum0->GetXaxis()->SetTitleOffset(1.08);
        hDum0->GetXaxis()->SetLabelSize(0.05);
        hDum0->Draw();
     }
    if(ieta==1){
        hDum1=(TH1F*)hDum->Clone();
        hDum1->GetXaxis()->SetTitleSize(0.078);
        hDum1->GetXaxis()->SetTitleOffset(0.97);
        hDum1->GetXaxis()->SetLabelSize(0.056);
        hDum1->GetXaxis()->SetLabelOffset(0.0);
        hDum1->Draw();
     }
    if(ieta==2){
        hDum2=(TH1F*)hDum->Clone();
        hDum2->GetXaxis()->SetTitleSize(0.078);
        hDum2->GetXaxis()->SetTitleOffset(0.97);
        hDum2->GetXaxis()->SetLabelSize(0.056);
        hDum2->GetXaxis()->SetLabelOffset(0.0);
        hDum2->Draw();
     }
            ...
            drawText(Form("CMS Preliminary pPb #sqrt{s_{NN}} = 5.02 TeV "),0.295,0.93,20);
            drawCMS(0.625,0.97,Lumi);
            c1->cd(2);
            //drawText(Form("Anti-k_{T} Particle Flow Jets: R = 0.3"),0.052,0.82,19);
            drawText(Form("Anti-k_{T} Particle Flow Jets: R = 0.3"),0.09,0.86,20);
            c1->cd();
            //     int ieta=netabin ;
/*
            double veta3[3][19]={
...
//xxx
            ...
            for(int ieta = 1 ; ieta <=netabin-2; ieta+=2){
                  if(ieta==1) c1->cd(1);
                  if(ieta==3) c1->cd(2);
                  if(ieta==5) c1->cd(3);
              ...
              drawSys(PARatio[ieta], ptboundary[ieta], ptCen[ieta], sys[ieta], 4, 0, ieta);
...
*/            
            ...
            c1->cd(1);
            TBox *box1 = new TBox(100.,1.71,130.5,1.77);
            box1->SetFillColor(5);
            box1->SetLineColor(5);
            box1->SetFillStyle(1001);
            box1->Draw("same");
            TLatex *tex1= new TLatex(150.0,1.71,"pp uncertainties");
            tex1->SetTextColor(1);
            tex1->SetTextSize(20);
            tex1->SetTextFont(43);
            tex1->Draw();
            TBox *box2 = new TBox(101.5,1.56,129,1.614);
         //   box2->SetFillColor(kYellow);
            box2->SetFillStyle(0);
            box2->SetLineColor(4);
            box2->SetLineWidth(2);
            box2->Draw("same");
            TLatex *tex1= new TLatex(150.0,1.56,"pPb uncertainties");
            tex1->SetTextColor(1);
            tex1->SetTextSize(20);
            tex1->SetTextFont(43);
            tex1->Draw();
            ...
            //t2->Draw("same");
            c1->cd(3);
            TBox *box1 = new TBox(71.5,1.63,89.5,1.685);
            box1->SetFillColor(kGreen+3);
            box1->SetLineColor(kGreen+3);
            box1->SetFillStyle(1001);
            box1->Draw("same");
            TLatex *tex1= new TLatex(98.0,1.63,"Luminosity uncertainties");
            tex1->SetTextColor(1);
            tex1->SetTextSize(20);
            tex1->SetTextFont(43);
            tex1->Draw();
...
//            }
    ...
    if(SavePlot)c1->Print(Form("%s/%s%sIncJet%s%s%s%sInterpolatedRefEtaBin%d3panelA.gif", plotsdir.Data(), val.Data(), algo.Data(),residual.Data(), ana.Data(), widebin.Data(), dep.Data(),netabin));
    if(SavePlot)c1->Print(Form("%s/%s%sIncJet%s%s%s%sInterpolatedRefEtaBin%d3panelA.C", plotsdir.Data(), val.Data(), algo.Data(),residual.Data(), ana.Data(), widebin.Data(), dep.Data(),netabin));
    c1->Update();
