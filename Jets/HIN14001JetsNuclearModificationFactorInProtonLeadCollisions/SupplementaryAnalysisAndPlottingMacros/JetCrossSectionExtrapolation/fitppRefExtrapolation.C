...
*/
 ...
 hist->SetYTitle("d^{2}#sigma/dp_{T}dy [mb]");
...
if(i<6){
    ...
    TLegend *leg0 = new TLegend(0.55,0.59,0.69,0.83);
...
c1->Print("ppCrossSectionExtrapolation.gif");
 ...
 hist2->SetYTitle("(Different input)/(Fitted default input)");
 ...
 hist2->Draw();
  ...
  if(i<6)gr2[i]->Draw("psameEZ");
    ...
    tex2->SetTextFont(43);
    tex2->Draw();
    TLegend *leg0 = new TLegend(0.2,0.16,0.36,0.36);
    leg0->SetFillColor(10);
    leg0->SetBorderSize(0.05);
    leg0->SetTextFont(43);
    leg0->SetTextSize(20.0);
...
c2->Print("ppFitExtrapolationRatio.gif");
