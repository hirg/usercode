...
c1->Print("ppCrossSectionExtrapolationupdown.gif");
 ...
 hist2->Draw();
  ...
  gr2[i] = new TGraphErrors(25, ptx[i], fratio[i], 0, ratioError[i]);
  ...
  if(i<3)gr2[i]->Draw("psameEZ");
    ...
    tex2->SetTextFont(43);
    tex2->Draw();
    TLegend *leg0 = new TLegend(0.2,0.16,0.36,0.35);
    leg0->SetFillColor(10);
    leg0->SetBorderSize(0.05);
    leg0->SetTextFont(43);
    leg0->SetTextSize(20.0);
...
c2->Print("ppFitExtrapolationRatioupdown.gif");
